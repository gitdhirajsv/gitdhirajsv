...
| **[Azalyst FundingPips Signals](https://azalyst.github.io/Azalyst-FundingPips-Signals/)** | **7-strategy prop-firm engine** (RSI · EMA5 · Ethereum Blueprint · SMT Divergence · JadeCap · QUANT-X · **Rebel Funding ML**) — each runs its own $100k FundingPips challenge with **Phase 1 (+8%) → Phase 2 (+5%)** tracking and real-time day counters · 1% risk under $5k daily / $10k max loss · Discord alerts · 15-min autonomous GitHub Actions cron · live dashboard. |
